    ...
    <div name="work" className="w-full md:h-full text-gray-300 bg-[#0e0e0e] md:mt-[12%]">
      <div className='max-w-[1000px] mx-auto px-4 flex flex-col justify-center w-full h-full'>
        ...
        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-6'>
          ...
          {/* Crowdfunding */}
          <div className='bg-slate-900 border border-white hover:bg-[#1a1a1a] justify-center items-center py-6 px-5 md:py-4 md:px-4 block mb-4 rounded-xl hover:shadow-md hover:shadow-[#6BD425] transition-all duration-1000 hover:transition-all hover:duration-1000 hover:scale-[101%]'>
            <div className='w-full h-[200px] mb-4 rounded-2xl relative overflow-hidden'>
              <div
                style={{ backgroundImage: `url(${crowdFunding})`, backgroundSize: 'cover', backgroundPosition: 'bottom' }}
                className='w-full h-[200px] absolute'
              />
              <div className='w-full h-[200px] absolute top-0 left-0 bg-[#0e0e0e] opacity-10 pointer-events-none'></div>
              <a href="https://github.com/priyans619/Crowdfunding-Platform" target="_blank" rel="noopener noreferrer">
                <button type='button' className='bg-[#1a1a1a] hover:bg-[#0e0e0e] rounded-full m-2 p-1.5 text-white text-3xl shadow-md hover:shadow-md hover:shadow-[#0e0e0e] shadow-[#0e0e0e] transition-all duration-700 hover:transition-all hover:duration-700 hover:scale-110 absolute'>
                  <AiFillGithub />
                </button>
              </a>
            </div>
            ...
            <div>
              ...
              <p className='text-sm text-gray-400 mb-1 mt-2 lg:line-clamp-5'>
                Developed a blockchain-based crowdfunding platform for smart contracts, allowing users to create campaigns. Integrated MetaMask for Ethereum transactions.
              </p>
              <div className='flex items-center justify-start text-sm gap-2 mt-2 pr-2'>
                <span className='text-[#32ca65] font-semibold flex items-center gap-0.5'>
                  <SiNodedotjs />NodeJs
                </span>
                <span className='text-[#6f25a1] font-semibold flex items-center gap-0.5'>
                  <SiHiveBlockchain />Thirdweb
                </span>
            ...
            <a href="https://crowdfunding-platform-three.vercel.app/" target="_blank" rel="noopener noreferrer">
              <button type='button' className='w-full bg-[#1a1a1a] hover:bg-[#0e0e0e] shadow-sm shadow-[#6BD425] rounded-md font-semibold p-2 mt-5 mb-2 hover:shadow-[#6BD425] transition-all duration-700 hover:transition-all hover:duration-700 hover:shadow-md hover:scale-[103%]'>
                Visit
              </button>
            </a>
          </div>
          ...
          {/* Movie App */}
          <div className='bg-slate-900 hover:bg-[#1a1a1a] justify-center items-center py-6 px-5 md:py-4 md:px-4 block mb-4 rounded-xl hover:shadow-md hover:shadow-[#6BD425] transition-all duration-1000 hover:transition-all hover:duration-1000 hover:scale-[101%] border border-white'>
            <div className='w-full h-[200px] mb-4 rounded-2xl relative overflow-hidden'>
